...
if ( ! class_exists( 'Kirki' ) ) {
	...
	if ( class_exists( 'WP_Customize_Section' ) && ! class_exists( 'Ornea_Kirki_Installer_Section' ) ) {
		/**
		 * Recommend the installation of Kirki using a custom section.
		 *
		 * @see WP_Customize_Section
		 */
		class Ornea_Kirki_Installer_Section extends WP_Customize_Section {
	...
	if ( ! function_exists( 'ornea_kirki_installer_register' ) ) {
		/**
		 * Registers the section, setting & control for the kirki installer.
		 *
		 * @param object $wp_customize The main customizer object.
		 */
		function ornea_kirki_installer_register( $wp_customize ) {
			$wp_customize->add_section(
				new Ornea_Kirki_Installer_Section(
		...
		add_action( 'customize_register', 'ornea_kirki_installer_register' );
	}
}
